...
router.get("/",(req,res)=>{
  ...
  res.json(friends)//This line is to be replaced with actual return value
});
...
router.get("/:email",(req,res)=>{
  ...
  res.json(friends[email])//This line is to be replaced with actual return value
});
...
router.delete("/:email", (req, res) => {
  ...
  // Update the code here
  res.send(`Friend with the email ${email} could not be deleted.`)//This line is to be replaced with actual return value
});
